...
class ApiClient {
  ...
  Future<ApiResult> post(String action, Map<String, dynamic> data) async {
    try {
      ...
      // Google Apps Script kadang mengalihkan (redirect) respons ke URL lain
      // sebelum menampilkan hasil aslinya. Beberapa versi library HTTP tidak
      // otomatis mengikuti redirect ini untuk request POST, sehingga perlu
